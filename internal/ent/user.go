...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldNickname, user.FieldUsername, user.FieldRole, user.FieldPasswordHash, user.FieldPhoneNumber, user.FieldStatus:
			values[i] = new(sql.NullString)
		case user.FieldBlockedAt, user.FieldCreatedAt, user.FieldUpdatedAt:
...
func (u *User) String() string {
	...
	builder.WriteString(u.BlockedAt.Format(time.ANSIC))
	builder.WriteString(", ")
