...
func (oiq *OrderItemQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (oiq *OrderItemQuery) FirstIDX(ctx context.Context) uint64 {
...
func (oiq *OrderItemQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (oiq *OrderItemQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (oiq *OrderItemQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (oiq *OrderItemQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := oiq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(orderitem.FieldDailyID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
